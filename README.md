...
2. Login to Cloudflare:
   - `npx wrangler login`
3. Deploy directly from this repository root:
   - `npx wrangler deploy`
4. Add your custom domain in Cloudflare Workers Routes / Domains settings.
...
3. 在仓库根目录直接部署：
   - `npx wrangler deploy`
4. 在 Cloudflare Workers 的 Routes / Domains 中绑定自定义域名。
